...
/* ----------------------------------------------------------------------------
   Ana — asistenta virtuală, în colțul din dreapta jos (WhatsApp stă în stânga).
      ...
      <AnimatePresence>
        {vizibil && (!inPagina || open) && (
          ...
          >
            ...
            >
              <AnaFace size={62} mood={open ? mood : indemn ? "listening" : "idle"} />
              <span className="hidden text-left sm:block">
                <span className="block font-display text-[1.15rem] leading-none text-ink">
                  {open ? "Închide" : "Întreab-o pe Ana"}
                </span>
                <span className="mt-1.5 block font-sans text-[0.78rem] text-ink-muted">
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="glass-strong fixed inset-x-3 bottom-[6.5rem] z-[46] flex h-[min(36rem,calc(100svh-8.5rem))] flex-col sm:inset-x-auto sm:right-6 sm:w-[25rem] lg:bottom-[7.75rem] lg:right-8"
          >
