          ...
          {AUDIENCES.items.map((item) => {
            ...
            return (
              <StaggerItem key={item.title}>
                <article className="lift group h-full rounded-none border border-ink/8 bg-cream-warm p-8 lg:p-9">
                  <div className="flex h-14 w-14 items-center justify-center rounded-none bg-periwinkle-pale text-periwinkle transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:bg-periwinkle group-hover:text-cream">
